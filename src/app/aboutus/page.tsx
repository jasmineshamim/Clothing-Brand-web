    ...
    return (
        ...
        <div className="py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white px-6 py-4 mx-auto text-gray-500 sm:px-4 sm:py-2 lg:px-20 lg:py-6">
                ...
                <br />
                <br />
                At <b>Jasmine Sheikh</b>, we believe that fashion is more than just clothing its a form of self-expression. Our collections are thoughtfully curated, blending luxurious fabrics with exquisite craftsmanship to offer you unique, trend-setting designs. From everyday essentials to special occasion wear, our pieces are designed to celebrate femininity while keeping comfort at the forefront.
                <br />
                <br />
                We are committed to sustainability and ethical practices, ensuring that each garment is crafted with care for both the wearer and the environment. Whether youre looking for bold, statement pieces or subtle, classic designs, <b>Jasmine Sheikh Clothing Brand</b> offers something for every woman who wants to embrace her personal style with confidence.
                <br />
                <br />
