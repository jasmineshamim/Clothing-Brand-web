            ...
            <nav className="bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden md:flex w-full justify-center space-x-8 font-medium py-4 text-black">
                            ...
                            <Link href="/partywear" className="navbar__link relative">PARTY WEAR</Link>
                            <Link href="/kid" className="navbar__link relative">KIDS COLLECTION</Link>
                            <Link href="/men" className="navbar__link relative">MENS COLLECTION</Link>
                ...
                >
                    <div className="px-6 pt-4 pb-6 space-y-1 sm:px-3">
                        ...
                        <div className="flex flex-col items-baseline pt-4 space-y-4 font-bold">
                            ...
                            <Link href="/partywear" onClick={toggleNavbar} className="navbar__link relative">PARTY WEAR</Link>
                            <Link href="/kid" onClick={toggleNavbar} className="navbar__link relative">KIDS COLLECTION</Link>
                            <Link href="/men" onClick={toggleNavbar} className="navbar__link relative">MENS COLLECTION</Link>
